function [xPoints, yPoints] = plotSpikeRaster(spikes, frameRate, varargin)
...
%     xlim([0+relSpikeStartTime nTimes*frameRate+1+relSpikeStartTime]); %JAK
     xlim([0 4]); %JAK - hardcode for now
    ylim([0 nTrials+1]);        
    ...
    switch plotType
        ...
        case 'vertline'
            ...
            [trials,timebins] = find(spikes);
            trials = trials';
            timebins = timebins'.*frameRate; %JAK
